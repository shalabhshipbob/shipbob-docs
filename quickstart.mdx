...
<CardGroup>
  ...
  <Card title="Create Analytics integration" icon="chart-mixed" href="/analytics/supported-integrations">
    Use the ShipBob API to create analytics integration
  </Card>
