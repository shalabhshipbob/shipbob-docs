---
title: "Concepts"
description: "When integrating with the ShipBob API, it’s helpful to have an understanding of specific terminology and concepts. Below are key terms that will help you navigate and use the API."
---
