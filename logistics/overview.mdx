...
If you need to refund or clean sweep shipping labels, you can use this endpoint.

### Endpoint

* **Sandbox**: `POST `[`https://logisticslabelprintingapi-stage.shipbob.dev/api/order:bulkcancel`](https://logisticslabelprintingapi-stage.shipbob.dev/api/order:bulkcancel)

* **Production**: `POST `[`https://logisticslabelprintingapi.shipbob.com/api/order:bulkcancel`](https://logisticslabelprintingapi.shipbob.com/api/order:bulkcancel)
