...
To get started, you’ll need a ShipBob account. Sign up for a sandbox account [here](https://webstage.shipbob.dev/app/merchant/#/SignUp?utm_source=app_partner). Let your ShipBob representative know once you have done this up and then they'll provide the necessary credentials.
